...
from .views import (add_to_cart_ajax,
                    BookListView,
                    BookDetailView,
                    AllBookListView, MyBookListView, BookCreateView, BookUpdateView, BookDeleteView)
                    #books_list_view,
                    #books_detail_view,
                    #all_books_list_view,
urlpatterns = [
     ...
     path('book_update/<int:pk>/', BookUpdateView.as_view(), name='book-update'),
     path('book_delete/<int:pk>/', BookDeleteView.as_view(), name='book-delete'),
]